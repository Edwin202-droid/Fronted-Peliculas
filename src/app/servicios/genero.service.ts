...
import { generoCreacionDTO, generoDTO } from '../interfaces/genero';
...
export class GeneroService {
  ...
  public obtenerGenerosPaginado(pagina:number,cantidadRegistrosAMostrar:number):Observable<any>{
  ...
  public editarGenero(id: number, genero: generoCreacionDTO){
    return this.http.put(`${this.apiURL}/${id}`, genero);
  }

  public borrarGenero(id:number){
